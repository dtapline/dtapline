...
|-------------|-------------|------------------|---------|
| Development | 780689416838 | cloudmatrix-dev | Push to `main` |
| Production | 127221304765 | cloudmatrix-prod | Release tag (changesets) |
...
### Connection Strings
```
Development: mongodb+srv://cloudmatrixcluster.ed0pems.mongodb.net/cloudmatrix-dev?authSource=%24external&authMechanism=MONGODB-AWS

Production: mongodb+srv://cloudmatrixcluster.ed0pems.mongodb.net/cloudmatrix-prod?authSource=%24external&authMechanism=MONGODB-AWS
```
